...
This starts Postgres, MinIO (the object store) and CrashCart on
`http://localhost:8080`. The schema and the bucket are created at startup. Open the address and create the first
