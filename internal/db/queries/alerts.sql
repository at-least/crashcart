...
-- The four default rules (enabled, default cooldown); existing rows untouched.
...
FROM unnest(ARRAY['new_issue', 'regression', 'unhandled_spike', 'escalating']::alert_type[]) AS t
