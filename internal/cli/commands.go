...
var Commands = []Command{
	...
	{Name: "rotate-key", Args: "<slug>", Summary: "issue a new DSN key (the old one stops within seconds)",
		Doc: "Generates a new DSN key and prints the new DSN. The old key keeps working for the few seconds the server caches project keys, then is refused."},
