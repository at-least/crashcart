...
Request (from the crashcart job worker, see internal/symbolicate/dsym.go):
  POST /symbolicate
  Content-Type: application/octet-stream
  X-Frames: [{"address": "0x1a2b", "module": "App"}, ...]
  <body: the raw dSYM binary, streamed from Postgres — never base64>

Response: {"frames": [{"function", "filename", "lineno"}, ...]} in X-Frames order.
